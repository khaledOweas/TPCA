...
export interface IZobaClient {
    get(): Observable<ZobasVM>;
    create(command: CreateZobaCommand): Observable<number>;
    delete(id: number): Observable<number>;
    update(id: number, command: UpdateZobaCommand): Observable<FileResponse>;
}

@Injectable({
    providedIn: 'root'
})
export class ZobaClient implements IZobaClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    get(): Observable<ZobasVM> {
        let url_ = this.baseUrl + "/api/Zoba";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<ZobasVM>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ZobasVM>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<ZobasVM> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ZobasVM.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    delete(id: number): Observable<number> {
        let url_ = this.baseUrl + "/api/Zoba/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
...
export class ZobasVM implements IZobasVM {
    zobas?: ZobaDto[];

    constructor(data?: IZobasVM) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["zobas"])) {
                this.zobas = [] as any;
                for (let item of _data["zobas"])
                    this.zobas!.push(ZobaDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ZobasVM {
        data = typeof data === 'object' ? data : {};
        let result = new ZobasVM();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        if (Array.isArray(this.zobas)) {
            data["zobas"] = [];
            for (let item of this.zobas)
                data["zobas"].push(item.toJSON());
        }
        return data;
    }
}

export interface IZobasVM {
    zobas?: ZobaDto[];
}

export class ZobaDto implements IZobaDto {
    id?: number;
    name?: string | undefined;
    age?: number;
    description?: string | undefined;

    constructor(data?: IZobaDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ZobaDto {
        data = typeof data === 'object' ? data : {};
        let result = new ZobaDto();
        result.init(data);
        return result;
    }
...
export class CreateZobaCommand implements ICreateZobaCommand {
    name?: string | undefined;
    age?: number;
    description?: string | undefined;

    constructor(data?: ICreateZobaCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateZobaCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateZobaCommand();
        result.init(data);
        return result;
    }
...
export interface ICreateZobaCommand {
    name?: string | undefined;
    age?: number;
    description?: string | undefined;
}

export class UpdateZobaCommand implements IUpdateZobaCommand {
    id?: number;
    name?: string | undefined;
    age?: number;
    description?: string | undefined;

    constructor(data?: IUpdateZobaCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateZobaCommand {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateZobaCommand();
        result.init(data);
        return result;
    }
...
export interface IUpdateZobaCommand {
    id?: number;
    name?: string | undefined;
    age?: number;
    description?: string | undefined;
